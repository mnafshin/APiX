# APiX Documentation Map

This page maps the in-repo documentation and suggests a reading order for new contributors.

Reading order (recommended):
1. docs/DocsMap.md (this page)
2. docs/proxy_mitm.md — HTTP proxying & TLS MITM
3. docs/grpc_protobuf.md — gRPC and protobuf contract
