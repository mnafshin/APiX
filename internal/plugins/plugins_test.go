...
type mockPlugin struct {
	name        string
	onRequestFn func(ctx context.Context, req *ProxyRequest) (*ProxyRequest, error)
	onResponseFn func(ctx context.Context, req *ProxyRequest, resp *ProxyResponse) (*ProxyResponse, error)
}
...
func (p *mockPlugin) OnRequest(ctx context.Context, req *ProxyRequest) (*ProxyRequest, error) {
...
func (p *mockPlugin) OnResponse(ctx context.Context, req *ProxyRequest, resp *ProxyResponse) (*ProxyResponse, error) {
...
func newProxyRequest(method, rawURL string) *ProxyRequest {
...
func newProxyResponse(statusCode int) *ProxyResponse {
...
func TestRunRequestChain(t *testing.T) {
	...
	p1 := &mockPlugin{
		name: "plugin-1",
		onRequestFn: func(_ context.Context, req *ProxyRequest) (*ProxyRequest, error) {
...
func TestRunResponseChain(t *testing.T) {
	...
	p1 := &mockPlugin{
		name: "resp-plugin-1",
		onResponseFn: func(_ context.Context, req *ProxyRequest, resp *ProxyResponse) (*ProxyResponse, error) {
