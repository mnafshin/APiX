...
type EngineClient interface {
	...
	// Clients should call this on connect and refuse to proceed if the API
	// version is incompatible with their own expectations.
...
var Engine_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/api/proto/apix.proto",
}
